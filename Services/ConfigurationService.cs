...
namespace AstroGathering.Services
{
    public class ConfigurationService
    {
        ...
        public string GoogleRedirectUrl => Environment.GetEnvironmentVariable("GOOGLE_REDIRECT_URL") ?? throw new InvalidOperationException("GOOGLE_REDIRECT_URI environment variable is not set");
    }
}
